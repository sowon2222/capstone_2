...
raw_dataset = load_jsonl_dataset("step2_from_augmented_please.jsonl")
...
training_args = TrainingArguments(
    output_dir="./lora_step2_answer_model",
...
# ✅ 모델 저장
model.save_pretrained("./lora_step2_answer_model/lora_adapter")
tokenizer.save_pretrained("./lora_step2_answer_model")
model.base_model.save_pretrained("lora_step2_answer_model/base")

print("✅ step2 학습 완료 및 저장됨")
