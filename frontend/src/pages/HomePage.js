...
export default function HomePage() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8">
      {/* 인사말 */}
      <div className="text-2xl font-bold mb-6">{token && userName && userName !== 'guest' ? `${userName}님, 오늘도 힘내요!` : 'guest님, 오늘도 힘내요!'}</div>
      ...
      {/* 중앙 2단 그리드 (왼: 타임라인, 오: 큐레이션+학습중/완료+랭킹) */}
      <div className="grid grid-cols-3 gap-6 mb-8">
        ...
        <div className="col-span-2 flex flex-col gap-6 w-full">
          ...
          <div className="grid grid-cols-2 gap-6 w-full">
            <div className="bg-[#23232a] rounded-2xl shadow-lg p-6">
      ...
      <div className="grid grid-cols-2 gap-6 mb-8">
        <div className="bg-[#18181b] rounded-2xl shadow-lg p-6 flex flex-col items-center justify-center">
